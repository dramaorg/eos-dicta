...
![CI](https://github.com/dramaorg/eos-dicta/workflows/CI/badge.svg)
[![NPM version](https://img.shields.io/npm/v/@dramaorg/eos-dicta.svg?style=flat)](https://www.npmjs.com/package/@dramaorg/eos-dicta)
...
`@dramaorg/eos-dicta` [v2.x](https://github.com/dramaorg/eos-dicta/tree/v2.x)
supports both Fastify@1 and Fastify@2.
`@dramaorg/eos-dicta` v3 only supports Fastify@2.

## Installation
```sh
npm i @dramaorg/eos-dicta
```

or

```sh
yarn add @dramaorg/eos-dicta
```
...
fastify.register(require('@dramaorg/eos-dicta'), {
...
```ts
import type { FastifyCookieOptions } from '@dramaorg/eos-dicta'
import cookie from '@dramaorg/eos-dicta'
...
```js
const { serialize, parse } = require('@dramaorg/eos-dicta')
const fastify = require('fastify')()
...
⚠️ **Warning:** [This is an attribute that has not yet been fully standardized](https://github.com/dramaorg/eos-dicta/pull/261#issuecomment-1803234334), and may change in the future without reflecting the semver versioning. This also means many clients may ignore the attribute until they understand it.
...
```js
fastify.register(require('@dramaorg/eos-dicta'), { secret: 'my-secret' })
...
```js
const { Signer } = require('@dramaorg/eos-dicta');
...
```js
const { fastifyCookie } = require('@dramaorg/eos-dicta');
